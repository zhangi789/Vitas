...
/**
 * author 张海洋
 * create on   2020/04/13 13:37
 * description   自定义SwitchButton
 *
 */

public class SwitchButtonView extends View implements Checkable {
    public int DEFAULT_WIDTH = dp2pxInt(64);
    public int DEFAULT_HEIGHT = dp2pxInt(36);
    /**
     * 动画状态：
     * 1.静止
     * 2.进入拖动
    ...
    public SwitchButtonView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        DEFAULT_WIDTH = optPixelSize(typedArray,
                R.styleable.SwitchButton_sb_width,
                dp2pxInt(64f));//dp2pxInt(2.5f);


        DEFAULT_HEIGHT = optPixelSize(typedArray,
                R.styleable.SwitchButton_sb_height,
                dp2pxInt(36f));//dp2pxInt(2.5f);
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(SwitchButtonView view, boolean isChecked);
    }
